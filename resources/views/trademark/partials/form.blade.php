<div class="col-md-8 col-sm-8 col-md-offset-2 col-sm-offset-2">
	<div class="panel panel-default">
		<div class="panel-heading"><h4>Datos necesarios del la marca para los productos</h4></div>
			...
			<form action="{{url($ruta)}}" class="form-horizontal" id="form_registrar" method="POST">
				...
				<div class="form-group">
					...
					<div class="col-md-4 col-sm-4">
						<input type="text" id="name" name="name" required="" class="form-control" value="{{$trademark->name}}">
					</div>
				</div>
				<div class="form-group">
					...
					<div class="col-md-3 col-sm-3">
						<a class="btn btn-link" href="{{route('trademark.index')}}">Volver a la vista de Marcas</a>
					</div>
				</div>
			</form>
		</div>
