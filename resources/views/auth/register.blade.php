                ...
                <form class="form-horizontal" method="POST" action="{{ url($ruta) }}">
                    ...
                    @if(!$edit)
                        <div class="form-group{{ $errors->has('password') ? ' has-error' : '' }}">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control" name="password" {{$user->password ? '' : 'required'}}>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-6">
                                <input id="password-confirm" type="password" class="form-control" name="password_confirmation" {{$user->password ? '' : 'required'}}>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="form-group{{ $errors->has('number') ? ' has-error' : '' }}">
                        ...
                        <div class="col-md-6">
                            <input type="number" id="number" name="number" class="form-control" required value="{{$user->number}}">
