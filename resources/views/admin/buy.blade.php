			...
			$('#form_buscar').submit(function(e) {
				...
				.done(function(data) {
					...
					$.grep(data,function(i,e) {
						rows+= '<tr><td>'+i.nombre_farmacia+'</td><td>'+i.director+'</td><td>'+i.director_number+'</td><td>'+i.director_email+'</td><td>'+i.cantidad+'</td><td class="letras-medianas"><a href="#" class="ver_compras" target="" user_id='+i.user_id+'><i class="fa fa-external-link-square"></i></a></td></tr>'
					})
