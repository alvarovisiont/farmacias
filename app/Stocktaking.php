...
{
    //
    protected $fillable = ['providers_id','users_id','trademarks_id','groups_id','product','component','quantity','price','buying_price_provider','buying_date','config_currencies_iva_id','config_currencies_discount_id'];
